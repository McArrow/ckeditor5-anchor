 ...
 * `id`. When the callback returns `true`, attributes are applied to the anchor.
 *
...
/**
 * Describes a manual {@link module:anchor/anchor~AnchorConfig#decorators anchor decorator}. This decorator type is represented in
 * the anchor feature's {@link module:anchor/anchorui user interface} as a switch that the user can use to control the presence
